    ...
    private void setMessageObjectInternal(MessageObject messageObject) {
        ...
        if (!hasPsaHint && (needAuthorName || viaBot)) {
            ...
            if (nameStringFinal != null && currentUser != null) {
                if (currentUser.premium && NaConfig.INSTANCE.getShowPremiumStarInChat().Bool()) {
                    ...
                    spannableStringBuilder.setSpan(new ColoredImageSpan(ContextCompat.getDrawable(getContext(), R.drawable.msg_premium_liststar), Theme.getColor(Theme.key_chats_menuName)), 0, 1, 0);
        ...
        if (drawForwardedName && messageObject.needDrawForwarded() && (currentPosition == null || currentPosition.minY == 0)) {
            ...
            if (currentForwardUser != null || currentForwardChannel != null || currentForwardName != null) {
                ...
                currentForwardNameString = showForwardDate(messageObject, currentForwardNameString);
